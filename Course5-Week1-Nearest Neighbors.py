# Implement the Nearest Neighbors Heuristic for the Traveling Salesman Problem. 
...
#
# The function should return the weight of the nearest neighbor heuristic, which starts at the vertex number 0,and then each time selects a closest vertex.
...
def nearest_neighbors(g):
    ...
    for _ in range(n - 1):
        ...
        for v in g.nodes():
            ...
            if v not in path and edge < min_edge:
                next_node = v
                min_edge = edge
